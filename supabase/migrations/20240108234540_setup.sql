...
AS $$
DECLARE
  project_url TEXT := 'https://qhvledvttjptoxmiypmv.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InFodmxlZHZ0dGpwdG94bWl5cG12Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxOTI4NzIyMywiZXhwIjoyMDM0ODYzMjIzfQ.4BzXFp7ZfOJsESNjVpZPvLz_o7ETOt3UNJC9H-GMj8c'; -- full access needed for http request to storage
